...
/*
 * Web server integration test for sampling/mcp-weather-webmvc-server
 * Tests the MCP sampling weather server with protocol validation
 */
...
public class RunMcpWeatherWebmvcServerWebServer {
    ...
    public static void main(String... args) throws Exception {
        ...
        try {
            ...
            out.println("🏗️  Building mcp-weather-webmvc-server...");
            ...
            out.println("🚀 Starting MCP sampling weather server in background...");
            ...
            if (mcpResult.success()) {
                out.println("\n🎉 MCP sampling weather server test passed!");
                ...
                err.println("\n❌ MCP sampling weather server test failed!");
